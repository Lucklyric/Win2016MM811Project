...
CREATE TABLE IF NOT EXISTS daily_query (
  ID int(9) unsigned NOT NULL AUTO_INCREMENT PRIMARY KEY,
  PLAYGROUNDS int(9)  NOT NULL,
  PUBLIC_SCHOOLS int(9)  NOT NULL,
  CATHOLIC_SCHOOLS int(9)  NOT NULL,
  SINGLE int(9) NOT NULL,
  DUPLEX int(9) NOT NULL,
  ROW_HOUSE int(9) NOT NULL,
  APARTMENT_FIVE int(9) NOT NULL,
  APARTMENT_FOUR int(9) NOT NULL,
  HOTEL int(9) NOT NULL,
  AGE_FOURTEEN   int(9)  NOT NULL,
  AGE_THIRTYFIVE   int(9)  NOT NULL,
  AGE_SIXTY  int(9)  NOT NULL,
  AGE_SIXTYPLUS   int(9)  NOT NULL,
  EMPLOYMENT_STUDENT   int(9)  NOT NULL,
  EMPLOYMENT_UNEMPLOYED   int(9)  NOT NULL,
  EMPLOYMENT_EMPLOYED   int(9)  NOT NULL,
  CREATE_TS timestamp NOT NULL 
      DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
